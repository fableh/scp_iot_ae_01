sap.ui.define([
	...
	"syc/blogs/iot/notebooks/model/formatter"
], function(Controller, formatter) {
	"use strict";

	return Controller.extend("syc.blogs.iot.notebooks.controller.ThingPage", {
		formatter: formatter,
		onInit: function() {
		...
		_onRouteMatched: function(oEvent) {
			...
			var iHighSeverity = arg.highSeverity;
			var iMediumSeverity = arg.mediumSeverity;
			var iLowSeverity = arg.lowSeverity;
			...
			this._renderSemanticBar(iHighSeverity, iMediumSeverity, iLowSeverity);
		},
		...
		_readDetailsService: function(oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_iotae_sycor_syc_sap_blogs_notebooks__Image,DYN_ENT_iotae_sycor_syc_sap_blogs_notebooks__Product_Data,DYN_ENT_iotae_sycor_syc_sap_blogs_notebooks__CPU"
				},
